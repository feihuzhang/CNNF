...
./CostFilter [stereo or flow] [target image] [feature for left view] [feature for right view] [max motion] [filtering radius] [eps for filtering]
the last two parameters can be neglected.
for example you can use
./CostFilter stereo left.png left.bin right.bin 100
./CostFilter flow view1.png view1.bin view2.bin 100 
